...
const { gg, best, score, tiles, init, back, canIBack, preset, nextPreset } = useG2048(domBoard)
  ...
  <div class="inline-flex flex-col gap-3 select-none">
    <div class="flex items-center justify-between">
      ...
      <div class="ml-2 flex self-end space-x-2">
        <div class="w-20 flex flex-col items-center rounded bg-orange-600/30 py-0.5">
    ...
    <div class="flex items-center justify-between">
      <div class="underline underline-offset-4">{{ locales.caption }}&nbsp;{{ gameLabel }}</div>
      ...
      <div class="flex items-center">
        ...
        <button class="ml-2 w-20 rounded bg-yellow-600/40 py-2 text-center text-xl" @click="init()">
          {{ locales.new }}
        </button>
      </div>
    </div>
    ...
    <div class="relative" @touchmove.stop.prevent>
      <div class="relative inline-block max-w-full overflow-auto rounded bg-[#bbada0] p-3">
      ...
      <Transition name="gg">
        ...
        >
          ...
          <button class="w-20 rounded bg-yellow-500 py-2 text-xl" @click="init()">
            {{ locales.again }}
          </button>
        </div>
      </Transition>
