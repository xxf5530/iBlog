...
import { gridLabelPresets, levelPresets, locales, stateEmojiPresets } from './config.json'
...
<template>
  <div class="flex flex-col gap-3">
    ...
    <div class="flex justify-center space-x-2">
      ...
      >
        <input id="toggleQuick" v-model="fastModel" type="checkbox" class="mr-2" />
      ...
      <label
        ...
        class="w-20 inline-flex justify-center items-center border px-4 py-1 rounded text-sm hover:bg-black/5 hover:dark:bg-white/10"
      >
        <input id="toggleFlag" v-model="flagModel" type="checkbox" class="mr-2" />
