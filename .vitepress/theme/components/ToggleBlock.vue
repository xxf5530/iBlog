...
const iconDefault = icon ?? 'i-carbon-data-enrichment'
</script>

<template>
  <div
    class="inline-flex-center gap-2 rounded border text-sm px-5 py-2 cursor-pointer active:scale-95 transition"
    hover="bg-dark/10 dark:bg-light/10"
    @click="open = !open"
  >
    <span :class="open ? 'i-line-md-close' : iconDefault"></span>
